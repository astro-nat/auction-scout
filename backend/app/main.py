...
_MIGRATIONS = [
    ...
    "ALTER TABLE lots ADD COLUMN IF NOT EXISTS image_urls JSONB",
    "ALTER TABLE lots ADD COLUMN IF NOT EXISTS seller_id VARCHAR",
    "ALTER TABLE lots ADD COLUMN IF NOT EXISTS seller_name VARCHAR",
    "CREATE INDEX IF NOT EXISTS ix_lots_seller_id ON lots (seller_id)",
